...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-gds-lokesh")
    bq_project = Variable.get("bq_project", default_var="gold-chassis-458312-c5")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "712797817724-compute@developer.gserviceaccount.com",
                "network_uri": "projects/gold-chassis-458312-c5/global/networks/default",
                "subnetwork_uri": "projects/gold-chassis-458312-c5/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="gold-chassis-458312-c5",
        region="us-central1",
